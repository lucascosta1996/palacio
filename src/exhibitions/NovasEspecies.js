          ...
          <InfiniteScroll
            ...
            endMessage={
              <div className="exhibitionDescription">
                ...
                <span>{i18n.t('NovasEspecies1.label', {lng})}</span>
                <span>{i18n.t('NovasEspecies2.label', {lng})}</span>
                <span>{i18n.t('NovasEspecies3.label', {lng})}</span>
                <span>{i18n.t('NovasEspecies4.label', {lng})}</span>
                <span>{i18n.t('NovasEspecies5.label', {lng})}</span>
                <span>{i18n.t('NovasEspecies6.label', {lng})}</span>
