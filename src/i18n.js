    ...
    resources: {
           pt: {
             translation: {
               ...
               dateTesting: { label: '24 de novembro, 2018 – 19 de janeiro 2019' },
               ...
               NovasEspeciesDescription5: { label: "O artificial e o orgânico-natural, o processo científico e a criação de simulados materiais, em contraste e atuando em conjunto.Como pilares principais para concepção da exibição, Novas Espécies baseia-se na criação e representação de composições entre seres, em conjunto à estética resultante da capacidade de variação infinita e irreplicável destes processos. " },
               ...
               ImaterialDescription4: { label: "Inclusa no sistema de escala de tempo proposto, projetada no espaço, uma linha fina materializa e desmaterializa sua composição, em um processo quase imperceptível ao espectador. Sincronizadas, na primeira sala da exibição, uma faixa azul propõe o mesmo;" },
           ...
           en: {
             translation: {
               ...
               dateTesting: { label: 'November 24, 2018 – January 19, 2019' },
