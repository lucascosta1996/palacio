    ...
    resources: {
         pt: {
           translation: {
             ...
             eventDate1: { label: '22 de julho, 2018' },
             eventDay1: { label: 'Sábado, 14h' },
             eventDate2: { label: '6 de julho, 2018' },
             eventDay2: { label: 'Sábado, 19h' },
             eventDate3: { label: '28 de abril, 2018' },
             eventDay3: { label: 'Sábado, 15h' },
             ...
             event2: { label: 'Palácio apresenta uma visita guiada com Emerson da Silva a exibição Terrestre, um dia após seu encerramento na Instituição. Uma sessão comentada do filme Adaptação reversa (2018) é realizada.' },
             ...
             NovasEspeciesDescription2: { label: "Duas composições, em salas distintas, constituídas de modo aleatório em sua disposição de elementos, introduzem a representações de ecossistemas terrestres. Uma junção fluída de matérias-primas que dividem um mesmo espaço, replicando a interação natural e equilibrada que ocorre em recortes da natureza — a ocupação de um mesmo terreno por várias espécies, de modo harmônico e interativo. Bloco de cimento, tela de aço, acrílico, em conjunto a composições de dispositivos de luz, sobre tecido branco, compõem as obras. Em ambientação escura, uma luz negra amplifica a presença das obras, maximizando a relação com o espaço." },
             NovasEspeciesDescription3: { label: "Em um local selecionado, três placas de Petri são dispostas no solo para uma coleta de amostras de matéria microbiota proveveniente do ambiente. Resulta-se, durante o tempo de exibição, na criação de um conjunto de espécies provenientes de um local específico, formados através de uma equação de seleção natural microbiota única — de replicagem inconcebível. O processo é documentado e apresentado em três fotos, induzindo o espectador a atmosfera espacial do ambiente definido para as coletas." },
             ...
             NovasEspeciesDescription5: { label: "Como pilares principais para concepção da exibição, Novas Espécies basea-se na criação e representação de composições entre seres, em conjunto a estética resultante da capacidade de variação infinita e irreplicável destes processos. O artificial e o orgânico-natural, o processo científico teórico e a criação de simulados materiais, em contraste e atuando em conjunto." },
             ...
             ImaterialDescription3: { label: "Incluso no sistema de escala de tempo proposto, projetado no espaço, uma linha fina materializa e desmaterializa sua composição, em um processo quase imperceptível ao espectador. Sincronizadas, na primeira sala da exibição, uma faixa azul propõe o mesmo; ambas de formato espacial maleável." },
             ImaterialDescription4: { label: "60 pontos de luz são incorporados ao espaço no decorrer de 60 minutos. A cada minuto, de modo aleatório, um ponto branco surge — na hora seguinte, o processo torna-se inverso. Gerada por algoritmos, pré-programada para que não haja repetição na disposição combinatória de pontos, a obra possui automação própria e, de forma mínima, opera para nunca ser a mesma; a cada minuto apresentar um estado visual único. Incorporando vida própria à obra, independente e auto-gestora de seu processo, em constante mutação." },
             ImaterialDescription5: { label: "Composta por frequências baixas, lineares e constantes, uma sonora dispersa em todo espaço sintetiza o ruído produzido pela pressão atmosférica terrestre — apresentado em conjunto com as projeções e em salas materialmente vazias. Cinco caixas de som interconectadas por bluetooth são distribuídas nos dois andares da Instituição, de modo a unificar e reverberar a exibição em um sistema unificado e linear. Em uma sala silenciosa, a sonora é proposta através de um headphone sem fio, para uso do espectador, pareado ao bluetooth da instalação." },
             ImaterialDescription6: { label: "Ao fim dos 120 minutos de processo completo das projeções, há um recesso de 10 minutos na exibição, com ambos os três espaços que hospedam-as tornando-se inteiramente vazios. Durante o intervalo, uma faixa de áudio distinta é reproduzida; uma composição mínima de resquícios sonoros." },
             ImaterialDescription7: { label: "A passagem do tempo e a noção de presença no espaço como eixos centrais para uma construção e apresentação totalmente digitais de Imaterial. Introduze-se a uma desmaterialização da obra de arte, com toda exibição sintetizada por um único micro cartão de armazenamento de arquivos digitais.O prédio torna-se uma cápsula, imerso pelo conceito e composição da exibição." },
             ImaterialDescription8: { label: "Andrés Stephanou (1993, Porto Alegre) vive e trabalha em Porto Alegre, Brasil." },
         ...
         en: {
           translation: {
             ...
             eventDate1: { label: 'June 22, 2018' },
             eventDay1: { label: 'Saturday, 2pm' },
             eventDate2: { label: 'July 6, 2018' },
             eventDay2: { label: 'Sábado, 7pm' },
             eventDate3: { label: 'April 28, 2018' },
             eventDay3: { label: 'Sábado, 3pm' },
             ...
             ImaterialDescription2: { label: "A sound installation and three projections compose the exhibition. In an orchestrated way, the works act centralized on a time scale: a cycle of 120 minutes, divided into two 60-minute stages. The projections presented perform, simultaneously, minute by minute, a process of solidification of its visual composition, followed by a dissolution process in the next hour." },
             ImaterialDescription3: { label: "Acting within the proposed time-scale system, projected in the space, a thin line materializes or dematerialise its composition, in a process almost imperceptible to the spectator. Synchronized, in the first room of the exhibition, a blue strip proposes the same; both the projections with a malleable spatial format. " },
             ImaterialDescription4: { label: "60 points of light are incorporated into the space within 60 minutes. Every minute, a random white dot appears  — under reverse process in the next hour. Generated by algorithms, pre-programmed to do not repeat the combinatorial arrangement of points, the work has its own automation and, in a minimal way, operates to never be the same; every minute presents a unique visual composition. Incorporates life itself to the work, independent and self-managing of its process; constantly changing. " },
             ImaterialDescription5: { label: "Composed with a bass, linear and constant frequencies, a sound scattered in all the space synthesizes the noise generated by the terrestrial atmospheric pressure — presented in conjunction with the projections and in individual empty rooms. Five bluetooth interconnected sound speakers are distributed on both floors, to unify and reverberate the exhibition in a linear system. In a quiet room, the sound is proposed through a headphone, for the spectator use, paired with the bluetooth of the installation." },
             ImaterialDescription6: { label: "At the end of the full 120 minutes process of the projections, a 10-minute recess occurs on the exhibition,  with both three spaces hosting it becoming entirely empty. During the interval, a distinct audio track is introduced: a minimal composition of sound remnants." },
             ImaterialDescription7: { label: "The time passage, in conjunction with the notion of presence in space, as central pillars for a fully digital construction and execution of Imaterial. Is introduced the dematerialization of the work of art, with all the exhibition synthesized by a single micro-card of digital files storage, under an automated system.The building becomes a capsule, immersed by the concept and composition of the exhibition." },
             ImaterialDescription8: { label: "Andrés Stephanou (1993, Porto Alegre) lives and works in Porto Alegre, Brazil. " },
