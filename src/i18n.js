    ...
    resources: {
         pt: {
           translation: {
             ...
             ImaterialDescription3: { label: "Uma instalação sonora e três projeções compõem a exibição. De modo orquestrado, atuam centralizadas por um sistema baseado em uma escala de tempo: um ciclo de 120 minutos, dividido em dois estágios de 60 minutos. As projeções apresentadas executam, simultaneamente, minuto a minuto, um processo de solidificação de sua composição visual, seguido de um processo de dissolução na hora seguinte." },
             ImaterialDescription4: { label: "Incluso no sistema de escala de tempo proposto, projetado no espaço, uma linha fina materializa e desmaterializa sua composição, em um processo quase imperceptível ao espectador. Sincronizadas, na primeira sala da exibição, uma faixa azul propõe o mesmo; ambas de formato espacial maleável." },
             ...
             ImaterialDescription6: { label: "Composta por frequências baixas, lineares e constantes, uma sonora dispersa em todo espaço sintetiza o ruído produzido pela pressão atmosférica terrestre — apresentado em conjunto com as projeções e em salas materialmente vazias. Cinco caixas de som interconectadas por bluetooth são distribuídas nos dois andares da Instituição, de modo a unificar e reverberar a exibição em um sistema unificado e linear. Em uma sala silenciosa, a sonora é proposta através de um headphone sem fio, para uso do espectador, pareado ao bluetooth da instalação." },
         ...
         en: {
           translation: {
             ...
             ImaterialDescription4: { label: "Acting within the proposed time-scale system, projected in the space, a thin line materializes or dematerialise its composition, in a process almost imperceptible to the spectator. Synchronized, in the first room of the exhibition, a blue strip proposes the same; both the projections with a malleable spatial format. " },
             ...
             ImaterialDescription7: { label: "At the end of the full 120 minutes process of the projections, a 10-minute recess occurs on the exhibition,  with both three spaces hosting it becoming entirely empty. During the interval, a distinct audio track is introduced: a minimal composition of sound remnants." },
