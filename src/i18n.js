    ...
    resources: {
           pt: {
             translation: {
               ...
               soon: { label: 'em breve' },
               about: { label: 'Desde 2016, Palácio é uma instituição de arte localizada em um espaço centenário no Centro Histórico da cidade. Apresenta exibições periódicas em formatos singulares e eventos extras, com visitas realizadas sob agendamento prévio.' },
           ...
           en: {
             translation: {
               ...
               about: { label: 'Since 2016, Palácio is an art Institution located in a centennial space in the Historic Center of the city. Presenting periodic exhibitions in singular formats and extra events, with visits made under previous scheduling.' },
