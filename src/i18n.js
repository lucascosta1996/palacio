    ...
    resources: {
      pt: {
        translation: {
          ...
          PEDescription2: { label: "Manufaturadas digitalmente e industrialmente, sob tonalidade metafórica, a exibição é composta por um conjunto híbrido de obras; de diálogo conceitual circular. O imaterial em contraste ao material, o digital em contraste à matérias-primas sintéticas." }, 
      ...
      en: {
        translation: {
          ...
          ImaterialDescription4: { label: "Acting within the proposed time-scale system, projected in the space, a thin line of light materializes and in sequence dematerializes its composition; continuously — under processes of 60 minutes each, almost imperceptible to the viewer. In the first room of the exhibition, a blue strip light proposes the same concept, in a temporal synchrony. " },
