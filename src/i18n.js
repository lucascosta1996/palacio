    ...
    resources: {
         pt: {
           translation: {
             ...
             TerrestreDescription4: { label: "Em um círculo de relação, instalada na parede de uma das salas, é introduzido um paralelo entre o ciclo de desenvolvimento natural de um vegetal e a criação de um pequeno ecossistema. Sementes germinadas em terra preta são apresentadas como amostragem de material terrestre vivo. Em constante processo, seu curso de vida é observado pelo expectador, desde o nascimento." },
