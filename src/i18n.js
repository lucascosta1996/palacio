 ...
 resources: {
          pt: {
            translation: {
              ...
              soon: { label: 'em breve' },
              about: { label: 'Desde 2016, Palácio é uma instituição de arte localizada em um espaço centenário no Centro Histórico, em Porto Alegre. Apresenta exibições periódicas em formatos singulares e eventos extras, com visitas realizadas sob agendamento prévio.' },
              ...
              ImaterialDescription4: { label: "Inclusa no sistema de escala de tempo proposto, projetada no espaço, uma linha fina de luz materializa e em sequência desmaterializa sua composição; continuamente — sob processos de 60 minutos cada, quase imperceptíveis ao espectador. Na primeira sala da exibição, uma faixa de luz azul propõe o mesmo conceito, em sincronia temporal." },
          ...
          en: {
            translation: {
              ...
              about: { label: 'Since 2016, Palácio is an art institution located in a centennial place in Historical Center of Porto Alegre. Presenting periodic exhibitions in singular formats and extra events, with visits made under previous scheduling.' },
              ...
              PEDescription2: { label: "Under a metaphorical tonality, the exhibition is composed by a hybrid set of works, with a circular conceptual dialogue —  manufactured digitally and industrially. The digital in contrast to synthetic raw materials, the immaterial in contrast to the material." },
              ...
              NovasEspeciesDescription2: { label: "The artificial and the creation of material simulations, the organic-natural and the use of scientific processes. As main pillars of the exhibition, Novas Espécies is based on the creation and representation of compositions between living beings, in conjunction with the aesthetic resulting from the capacity of infinite and irreplicable variation of these processes. "},
              ...
              NovasEspeciesDescription5: { label: "The collected units are arranged together at the exhibition, in a wall of the empty space. Under the same mode of presentation, in another room, generated from a process of cloning the collected matter, three other species are inoculated. " },
              ...
              ImaterialDescription4: { label: "Acting within the proposed time-scale system, projected in the space, a thin line of light materializes materializes and in sequence dematerializes its composition; continuously — under processes of 60 minutes each, almost imperceptible to the viewer. In the first room of the exhibition, a blue strip light proposes the same concept, in a temporal synchrony. " },
